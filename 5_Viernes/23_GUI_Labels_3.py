...
botonMen = Button(frame1, text="-", width=3,command=lambda:resta(numPantalla.get()))
...
botonMas = Button(frame1, text="+", width=3,command=lambda:suma(numPantalla.get()))
...
botonIgual = Button(frame1, text="=", width=3,command=lambda:result())
